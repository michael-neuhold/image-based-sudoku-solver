...
/* BEGIN: Cython Metadata
{
    "distutils": {
        "name": "sudoku_cython",
        "sources": [
            "C:\\Users\\Julian\\Documents\\FH\\python_sudoku\\sudoku_lib\\sudoku_cython.pyx"
        ]
    },
    "module_name": "sudoku_cython"
}
END: Cython Metadata */
...
#define __PYX_HAVE__sudoku_cython
#define __PYX_HAVE_API__sudoku_cython
/* Early includes */
#include "pythread.h"
#include <string.h>
#include <stdlib.h>
...
/* Module declarations from 'sudoku_cython' */
...
static __Pyx_memviewslice __pyx_f_13sudoku_cython_calc_component_bound(__Pyx_memviewslice, __Pyx_memviewslice, int __pyx_skip_dispatch); /*proto*/
...
#define __Pyx_MODULE_NAME "sudoku_cython"
extern int __pyx_module_is_main_sudoku_cython;
int __pyx_module_is_main_sudoku_cython = 0;

/* Implementation of 'sudoku_cython' */
...
static const char __pyx_k_comp_img[] = "comp_img";
static const char __pyx_k_getstate[] = "__getstate__";
static const char __pyx_k_itemsize[] = "itemsize";
static const char __pyx_k_pyx_type[] = "__pyx_type";
static const char __pyx_k_setstate[] = "__setstate__";
static const char __pyx_k_TypeError[] = "TypeError";
static const char __pyx_k_bound_img[] = "bound_img";
...
static PyObject *__pyx_n_s_bound_img;
static PyObject *__pyx_n_s_c;
static PyObject *__pyx_n_u_c;
static PyObject *__pyx_n_s_class;
static PyObject *__pyx_n_s_cline_in_traceback;
static PyObject *__pyx_n_s_comp_img;
...
static PyObject *__pyx_pf_13sudoku_cython_calc_component_bound(CYTHON_UNUSED PyObject *__pyx_self, __Pyx_memviewslice __pyx_v_comp_img, __Pyx_memviewslice __pyx_v_bound_img); /* proto */
...
static PyObject *__pyx_pw_13sudoku_cython_1calc_component_bound(PyObject *__pyx_self, PyObject *__pyx_args, PyObject *__pyx_kwds); /*proto*/
static __Pyx_memviewslice __pyx_f_13sudoku_cython_calc_component_bound(__Pyx_memviewslice __pyx_v_comp_img, __Pyx_memviewslice __pyx_v_bound_img, CYTHON_UNUSED int __pyx_skip_dispatch) {
  int __pyx_v_y;
  int __pyx_v_x;
  int __pyx_v_width;
  int __pyx_v_height;
  ...
  __Pyx_RefNannySetupContext("calc_component_bound", 0);
 ...
 */
  __pyx_v_height = (__pyx_v_comp_img.shape[0]);

  /* "sudoku_cython.pyx":10
 *     cdef int y, x, width, height
 *     height = comp_img.shape[0]
 *     width = comp_img.shape[1]             # <<<<<<<<<<<<<<
 *     for y in range(height):
 *         x = 0
 */
  __pyx_v_width = (__pyx_v_comp_img.shape[1]);

  /* "sudoku_cython.pyx":11
 *     height = comp_img.shape[0]
 *     width = comp_img.shape[1]
 *     for y in range(height):             # <<<<<<<<<<<<<<
 *         x = 0
 ...
 */
    while (1) {
      __pyx_t_5 = ((__pyx_v_x < __pyx_v_width) != 0);
      if (__pyx_t_5) {
      } else {
        __pyx_t_4 = __pyx_t_5;
      ...
      __pyx_t_6 = __pyx_v_y;
      __pyx_t_7 = __pyx_v_x;
      if (__pyx_t_6 < 0) __pyx_t_6 += __pyx_v_comp_img.shape[0];
      if (__pyx_t_7 < 0) __pyx_t_7 += __pyx_v_comp_img.shape[1];
      __pyx_t_5 = (((*((unsigned char *) ( /* dim=1 */ (( /* dim=0 */ (__pyx_v_comp_img.data + __pyx_t_6 * __pyx_v_comp_img.strides[0]) ) + __pyx_t_7 * __pyx_v_comp_img.strides[1]) ))) == 0) != 0);
      __pyx_t_4 = __pyx_t_5;
      __pyx_L7_bool_binop_done:;
      if (!__pyx_t_4) break;

      /* "sudoku_cython.pyx":14
 *         x = 0
 *         while (x < width and comp_img[y][x] == 0):
 *             x += 1             # <<<<<<<<<<<<<<
 * 
 ...
 *             x = width-1
 */
    __pyx_t_4 = ((__pyx_v_x < __pyx_v_width) != 0);
    if (__pyx_t_4) {

      /* "sudoku_cython.pyx":17
 * 
 *         if x < width:
 *             bound_img[y][x] = 255             # <<<<<<<<<<<<<<
 *             x = width-1
 ...
 */
      __pyx_t_7 = __pyx_v_y;
      __pyx_t_6 = __pyx_v_x;
      if (__pyx_t_7 < 0) __pyx_t_7 += __pyx_v_bound_img.shape[0];
      if (__pyx_t_6 < 0) __pyx_t_6 += __pyx_v_bound_img.shape[1];
      *((unsigned char *) ( /* dim=1 */ (( /* dim=0 */ (__pyx_v_bound_img.data + __pyx_t_7 * __pyx_v_bound_img.strides[0]) ) + __pyx_t_6 * __pyx_v_bound_img.strides[1]) )) = 0xFF;

      /* "sudoku_cython.pyx":18
 *         if x < width:
 *             bound_img[y][x] = 255
 *             x = width-1             # <<<<<<<<<<<<<<
 *             while (x > 0 and comp_img[y][x] == 0):
 ...
 */
  ...
  /* "sudoku_cython.pyx":25
 *                 bound_img[y][x] = 255
 * 
 *     return bound_img             # <<<<<<<<<<<<<<
 */
  __PYX_INC_MEMVIEW(&__pyx_v_bound_img, 0);
  __pyx_r = __pyx_v_bound_img;
  goto __pyx_L0;
...
/* Python wrapper */
static PyObject *__pyx_pw_13sudoku_cython_1calc_component_bound(PyObject *__pyx_self, PyObject *__pyx_args, PyObject *__pyx_kwds); /*proto*/
static PyObject *__pyx_pw_13sudoku_cython_1calc_component_bound(PyObject *__pyx_self, PyObject *__pyx_args, PyObject *__pyx_kwds) {
  __Pyx_memviewslice __pyx_v_comp_img = { 0, 0, { 0 }, { 0 }, { 0 } };
  __Pyx_memviewslice __pyx_v_bound_img = { 0, 0, { 0 }, { 0 }, { 0 } };
  int __pyx_lineno = 0;
  const char *__pyx_filename = NULL;
  int __pyx_clineno = 0;
  PyObject *__pyx_r = 0;
  __Pyx_RefNannyDeclarations
  __Pyx_RefNannySetupContext("calc_component_bound (wrapper)", 0);
  {
    static PyObject **__pyx_pyargnames[] = {&__pyx_n_s_comp_img,&__pyx_n_s_bound_img,0};
    ...
    if (unlikely(__pyx_kwds)) {
      ...
      switch (pos_args) {
        case  0:
        if (likely((values[0] = __Pyx_PyDict_GetItemStr(__pyx_kwds, __pyx_n_s_comp_img)) != 0)) kw_args--;
        else goto __pyx_L5_argtuple_error;
        CYTHON_FALLTHROUGH;
        case  1:
        if (likely((values[1] = __Pyx_PyDict_GetItemStr(__pyx_kwds, __pyx_n_s_bound_img)) != 0)) kw_args--;
        else {
          __Pyx_RaiseArgtupleInvalid("calc_component_bound", 1, 2, 2, 1); __PYX_ERR(0, 7, __pyx_L3_error)
        }
      }
      if (unlikely(kw_args > 0)) {
        if (unlikely(__Pyx_ParseOptionalKeywords(__pyx_kwds, __pyx_pyargnames, 0, values, pos_args, "calc_component_bound") < 0)) __PYX_ERR(0, 7, __pyx_L3_error)
      }
    ...
    __pyx_v_comp_img = __Pyx_PyObject_to_MemoryviewSlice_dsds_unsigned_char(values[0], PyBUF_WRITABLE); if (unlikely(!__pyx_v_comp_img.memview)) __PYX_ERR(0, 7, __pyx_L3_error)
    __pyx_v_bound_img = __Pyx_PyObject_to_MemoryviewSlice_dsds_unsigned_char(values[1], PyBUF_WRITABLE); if (unlikely(!__pyx_v_bound_img.memview)) __PYX_ERR(0, 7, __pyx_L3_error)
  }
  goto __pyx_L4_argument_unpacking_done;
  __pyx_L5_argtuple_error:;
  __Pyx_RaiseArgtupleInvalid("calc_component_bound", 1, 2, 2, PyTuple_GET_SIZE(__pyx_args)); __PYX_ERR(0, 7, __pyx_L3_error)
  __pyx_L3_error:;
  __Pyx_AddTraceback("sudoku_cython.calc_component_bound", __pyx_clineno, __pyx_lineno, __pyx_filename);
  __Pyx_RefNannyFinishContext();
  return NULL;
  __pyx_L4_argument_unpacking_done:;
  __pyx_r = __pyx_pf_13sudoku_cython_calc_component_bound(__pyx_self, __pyx_v_comp_img, __pyx_v_bound_img);
...
static PyObject *__pyx_pf_13sudoku_cython_calc_component_bound(CYTHON_UNUSED PyObject *__pyx_self, __Pyx_memviewslice __pyx_v_comp_img, __Pyx_memviewslice __pyx_v_bound_img) {
  ...
  if (unlikely(!__pyx_v_comp_img.memview)) { __Pyx_RaiseUnboundLocalError("comp_img"); __PYX_ERR(0, 7, __pyx_L1_error) }
  if (unlikely(!__pyx_v_bound_img.memview)) { __Pyx_RaiseUnboundLocalError("bound_img"); __PYX_ERR(0, 7, __pyx_L1_error) }
  __pyx_t_1 = __pyx_f_13sudoku_cython_calc_component_bound(__pyx_v_comp_img, __pyx_v_bound_img, 0); if (unlikely(!__pyx_t_1.memview)) __PYX_ERR(0, 7, __pyx_L1_error)
  __pyx_t_2 = __pyx_memoryview_fromslice(__pyx_t_1, 2, (PyObject *(*)(char *)) __pyx_memview_get_unsigned_char, (int (*)(char *, PyObject *)) __pyx_memview_set_unsigned_char, 0);; if (unlikely(!__pyx_t_2)) __PYX_ERR(0, 7, __pyx_L1_error)
  ...
  __pyx_r = NULL;
  __pyx_L0:;
  __PYX_XDEC_MEMVIEW(&__pyx_v_comp_img, 1);
  __PYX_XDEC_MEMVIEW(&__pyx_v_bound_img, 1);
...
static PyTypeObject __pyx_type___pyx_memoryview = {
  PyVarObject_HEAD_INIT(0, 0)
  "sudoku_cython.memoryview", /*tp_name*/
...
static PyTypeObject __pyx_type___pyx_memoryviewslice = {
  PyVarObject_HEAD_INIT(0, 0)
  "sudoku_cython._memoryviewslice", /*tp_name*/
...
static PyMethodDef __pyx_methods[] = {
  {"calc_component_bound", (PyCFunction)(void*)(PyCFunctionWithKeywords)__pyx_pw_13sudoku_cython_1calc_component_bound, METH_VARARGS|METH_KEYWORDS, 0},
  {0, 0, 0, 0}
};
...
static int __pyx_pymod_exec_sudoku_cython(PyObject* module); /*proto*/
static PyModuleDef_Slot __pyx_moduledef_slots[] = {
  {Py_mod_create, (void*)__pyx_pymod_create},
  {Py_mod_exec, (void*)__pyx_pymod_exec_sudoku_cython},
  {0, NULL}
};
#endif
...
static __Pyx_StringTabEntry __pyx_string_tab[] = {
  ...
  {&__pyx_n_s_bound_img, __pyx_k_bound_img, sizeof(__pyx_k_bound_img), 0, 0, 1, 1},
  {&__pyx_n_s_c, __pyx_k_c, sizeof(__pyx_k_c), 0, 0, 1, 1},
  {&__pyx_n_u_c, __pyx_k_c, sizeof(__pyx_k_c), 0, 1, 0, 1},
  {&__pyx_n_s_class, __pyx_k_class, sizeof(__pyx_k_class), 0, 0, 1, 1},
  {&__pyx_n_s_cline_in_traceback, __pyx_k_cline_in_traceback, sizeof(__pyx_k_cline_in_traceback), 0, 0, 1, 1},
  {&__pyx_n_s_comp_img, __pyx_k_comp_img, sizeof(__pyx_k_comp_img), 0, 0, 1, 1},
...
#if PY_MAJOR_VERSION < 3
__Pyx_PyMODINIT_FUNC initsudoku_cython(void) CYTHON_SMALL_CODE; /*proto*/
__Pyx_PyMODINIT_FUNC initsudoku_cython(void)
#else
__Pyx_PyMODINIT_FUNC PyInit_sudoku_cython(void) CYTHON_SMALL_CODE; /*proto*/
__Pyx_PyMODINIT_FUNC PyInit_sudoku_cython(void)
#if CYTHON_PEP489_MULTI_PHASE_INIT
{
...
static CYTHON_SMALL_CODE int __pyx_pymod_exec_sudoku_cython(PyObject *__pyx_pyinit_module)
#endif
#endif
{
  PyObject *__pyx_t_1 = NULL;
  ...
  if (__pyx_m) {
    ...
    PyErr_SetString(PyExc_RuntimeError, "Module 'sudoku_cython' has already been imported. Re-initialisation is not supported.");
    return -1;
  }
  #elif PY_MAJOR_VERSION >= 3
...
if (!__Pyx_RefNanny) {
...
#endif
  __Pyx_RefNannySetupContext("__Pyx_PyMODINIT_FUNC PyInit_sudoku_cython(void)", 0);
  ...
  #else
  #if PY_MAJOR_VERSION < 3
  __pyx_m = Py_InitModule4("sudoku_cython", __pyx_methods, 0, 0, PYTHON_API_VERSION); Py_XINCREF(__pyx_m);
  #else
  ...
  #endif
  if (__pyx_module_is_main_sudoku_cython) {
    if (PyObject_SetAttr(__pyx_m, __pyx_n_s_name_2, __pyx_n_s_main) < 0) __PYX_ERR(0, 1, __pyx_L1_error)
  }
  #if PY_MAJOR_VERSION >= 3
  {
    PyObject *modules = PyImport_GetModuleDict(); if (unlikely(!modules)) __PYX_ERR(0, 1, __pyx_L1_error)
    if (!PyDict_GetItemString(modules, "sudoku_cython")) {
      if (unlikely(PyDict_SetItemString(modules, "sudoku_cython", __pyx_m) < 0)) __PYX_ERR(0, 1, __pyx_L1_error)
    }
  }
  #endif
  /*--- Builtin init code ---*/
 ...
 */
  ...
  if (__pyx_m) {
    if (__pyx_d) {
      __Pyx_AddTraceback("init sudoku_cython", __pyx_clineno, __pyx_lineno, __pyx_filename);
    }
    Py_CLEAR(__pyx_m);
  } else if (!PyErr_Occurred()) {
    PyErr_SetString(PyExc_ImportError, "init sudoku_cython");
  }
  __pyx_L0:;
  __Pyx_RefNannyFinishContext();
  #if CYTHON_PEP489_MULTI_PHASE_INIT
